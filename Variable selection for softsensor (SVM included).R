...
#-----------------combined with SVM method-----------------------------
library(e1071)

obj <- tune.svm(preprocessed.y~., data = multi.regression.compounds.train, gamma = 2^(-3:-1), cost = 2^(-3:5), epsilon = 2^(-3:-1))
obj$best.model
compounds.svr <- svm(multi.regression.x.train,preprocessed.y.train,gammma = obj$best.parameters[,c(1)], cost = obj$best.parameters[,c(2)], epsilon = obj$best.parameters[,c(3)])
summary(compounds.svr)
obj$best.parameters
...
#------------------------SVM-vip------------------------------
obj.vip <- tune.svm(preprocessed.y.train~., data = multi.regression.compounds.train.vip, gamma = 2^(-3:-1), cost = 2^(-3:5), epsilon = 2^(-3:-1))
obj.vip$best.model
compounds.svr.vip <- svm(x.vip.train,preprocessed.y.train,gammma = obj.vip$best.parameters[,c(1)], cost = obj.vip$best.parameters[,c(2)], epsilon = obj.vip$best.parameters[,c(3)])
...
#------------------------SVM-uve------------------------------
obj.uve <- tune.svm(preprocessed.y.train~., data = multi.regression.compounds.train.uve, gamma = 2^(-3:-1), cost = 2^(-3:5), epsilon = 2^(-3:-1))
obj.uve$best.model
compounds.svr.uve <- svm(x.uve.train,preprocessed.y.train,gammma = obj.uve$best.parameters[,c(1)], cost = obj.uve$best.parameters[,c(2)], epsilon = obj.uve$best.parameters[,c(3)])
...
#------------------------SVM-GA------------------------------
obj.ga <- tune.svm(preprocessed.y.train~., data = multi.regression.compounds.train.ga, gamma = 2^(-3:-1), cost = 2^(-3:5), epsilon = 2^(-3:-1))
obj.ga$best.model
compounds.svr.ga <- svm(x.ga.train,preprocessed.y.train,gammma = obj.ga$best.parameters[,c(1)], cost = obj.ga$best.parameters[,c(2)], epsilon = obj.ga$best.parameters[,c(3)])
...
#--------------------------------summary------------------------------------------------------------------------
summary.train <-cbind(lm.r2,plsr.r2,plsr.r2.uve,plsr.r2.vip,plsr.r2.ga,svm.r2.train,svm.r2.train.vip,svm.r2.train.uve,svm.r2.train.ga)
View(summary.train)
summary.test <- cbind(lm.r2.test,pls.r2.test,pls.r2.uve.test,pls.r2.vip.test,pls.r2.ga.test,svm.r2.test,svm.r2.test.vip,svm.r2.test.uve,svm.r2.test.ga)
View(summary.test)
stability <- summary.test / summary.train*100
View(stability)
